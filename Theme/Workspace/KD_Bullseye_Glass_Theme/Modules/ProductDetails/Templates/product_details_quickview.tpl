{{!-- <div class="product-details-quickview">
	...
	<div class="product-details-quickview-details">
		...
		<div class="product-details-quickview-main">
			...
			<div id="banner-details-bottom" class="product-details-quickview-banner-details-bottom" data-cms-area="item_info_bottom_kidgolf" data-cms-area-filters="page_type"></div>
		</div>
