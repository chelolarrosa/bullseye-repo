<div class="cart-detailed">
	...
	<div data-cms-area="cart_detailed_cms_area_1_kidgolf" data-cms-area-filters="path"></div>
	...
	<div class="cart-detailed-body">
		<section class="{{#if showLines}}cart-detailed-left {{else}}cart-detailed-empty{{/if}}">
			...
			<div data-cms-area="cart_detailed_cms_area_2_kidgolf" data-cms-area-filters="path"></div>
		</section>
	...
	<div data-cms-area="cart_detailed_cms_area_3_kidgolf" data-cms-area-filters="path"></div>
</div>
