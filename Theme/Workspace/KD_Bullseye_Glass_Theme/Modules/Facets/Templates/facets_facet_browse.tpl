{{!-- <section class="facets-facet-browse">
	<div data-cms-area="item_list_banner_kidgolf" data-cms-area-filters="page_type"></div>
	...
	{{#if showResults}}
		<div class="facets-facet-browse-content">
			...
			<div class="facets-facet-browse-facets" data-action="pushable" data-id="product-search-facets">
				...
				<div data-cms-area="facet_navigation_top_kidgolf" data-cms-area-filters="page_type"></div>
				...
				<div data-cms-area="facet_navigation_bottom_kidgolf" data-cms-area-filters="page_type"></div>
			</div>
			...
			<div class="facets-facet-browse-results" itemscope="" itemtype="https://schema.org/ItemList">
				...
				<div data-cms-area="facets_facet_browse_cms_area_1_kidgolf" data-cms-area-filters="page_type"></div>
		...
		<div class="facets-facet-browse-cms-area-2" data-cms-area="facets_facet_browse_cms_area_2_kidgolf" data-cms-area-filters="page_type"></div>

	{{else}}
		<div class="facets-facet-browse-empty-items" data-view="Facets.Items.Empty"></div>
	{{/if}}

	<div id="banner-section-bottom" class="content-banner banner-section-bottom facets-facet-browse-banner-section-bottom" data-cms-area="item_list_banner_bottom_kidgolf" data-cms-area-filters="page_type"></div>
</section> --}}
...
<section class="facets-facet-browse">
		...
		<header class="facets-facet-browse-header">
			...
			<nav class="facets-facet-browse-list-header">
				...
				<div class="facets-facet-browse-list-header-filters collapse" id="list-header-filters">
					...
					<meta itemprop="name" content="{{title}}"/>
					<div id="banner-section-top" class="content-banner banner-section-top" data-cms-area="item_list_banner_top_kidgolf" data-cms-area-filters="path"></div>
	...
	<div id="banner-section-bottom" class="content-banner banner-section-bottom" data-cms-area="item_list_banner_bottom_kidgolf" data-cms-area-filters="page_type"></div>
</section>
