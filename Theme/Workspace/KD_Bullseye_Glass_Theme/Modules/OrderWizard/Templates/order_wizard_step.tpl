...
<div data-cms-area="order_wizard_cms_area_1_kidgolf" data-cms-area-filters="page_type"></div>
<div class="order-wizard-step-content-wrapper">
	
	<div class="order-wizard-step-content-main">
		<div data-cms-area="order_wizard_cms_area_2_kidgolf" data-cms-area-filters="page_type"></div>
		<section id="wizard-step-content"></section>
		<div data-cms-area="order_wizard_cms_area_3_kidgolf" data-cms-area-filters="page_type"></div>
	</div>


	<div class="order-wizard-step-content-secondary">
		<div data-cms-area="order_wizard_cms_area_4_kidgolf" data-cms-area-filters="page_type"></div>
